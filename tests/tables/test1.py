from stdp import SDML_STRING, SDML_NUMBER, SDML_DATE, SDML_TIME_OF_DAY, SDML_DATETIME, SDML_BOOLEAN
from sdtp import RowTable

schema = [{ "name": "name", "type": SDML_STRING }, { "name": "age", "type": SDML_NUMBER }, { "name": "date", "type": SDML_DATE }, { "name": "time", "type": SDML_TIME_OF_DAY }, { "name": "datetime", "type": SDML_DATETIME }, { "name": "boolean", "type": SDML_BOOLEAN } ]
rows = [
...
test_table = RowTable(schema, rows)
